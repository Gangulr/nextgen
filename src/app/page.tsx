...
const features = [
  {
    ...
    icon: (
      <svg
        className="h-8 w-8 text-cosmic-purple"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor"
      >
...
const testimonials = [
  {
    ...
    content:
      "Their team delivered our project ahead of schedule with exceptional quality. Truly impressed with their professionalism.",
  ...
  },
  {
    ...
    content:
      "The custom software they built transformed our operations. Highly recommend their services to any business.",
    avatar: "/images/avatar1.jpg",
  ...
  },
  {
    ...
    content:
      "From concept to deployment, their team was with us every step of the way. Outstanding results!",
    avatar: "/images/avatar1.jpg",
...
const techStack = [
  { name: "React", color: "bg-black text-stellar-white" },
  { name: "Next.js", color: "bg-black text-stellar-white" },
  { name: "Node.js", color: "bg-black text-stellar-white" },
  { name: "Tailwind", color: "bg-black text-stellar-white" },
  { name: "AWS", color: "bg-black text-stellar-white" },
  { name: "Docker", color: "bg-black text-stellar-white" },
  { name: "Flutter", color: "bg-black text-stellar-white" },
  { name: "Python", color: "bg-black text-stellar-white" },
  { name: "Django", color: "bg-black text-stellar-white" },
  { name: "Flask", color: "bg-black text-stellar-white" },
  { name: "Git", color: "bg-black text-stellar-white" },
];
      ...
      <div className="relative bg-gradient-to-br from-deep-space to-cosmic-purple overflow-hidden min-h-[80vh] flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          ...
          <motion.div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 10% 20%, rgba(99, 102, 241, 0.8) 0%, transparent 20%), radial-gradient(circle at 90% 80%, rgba(139, 92, 246, 0.6) 0%, transparent 20%)",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={itemVariants} className="lg:text-center">
              <h2 className="text-base text-stellar-accent font-semibold tracking-wide uppercase">
                Services
              </h2>
            ...
            <motion.div variants={itemVariants} className="mt-16">
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                {features.map((feature) => (
                  ...
                  >
                    <div
                      className={`absolute -top-6 left-6 flex items-center justify-center h-12 w-12 rounded-xl ${feature.bgColor} border border-galaxy-indigo/30 text-cosmic-purple shadow-lg`}
                    >
                      {feature.icon}
                    </div>
                    <div className="mt-6">
                      ...
                      <p className="mt-2 text-nebula-blue-200">
                        {feature.description}
                      </p>
                    </div>
                  </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mt-4 max-w-2xl text-xl text-nebula-blue-200 mx-auto">
              We work with modern technologies to deliver high-performance
              solutions
            </p>
          </motion.div>
          ...
          >
            {techStack.map((tech) => (
              ...
              >
                <div
                  className={`flex items-center justify-center w-16 h-16 rounded-xl ${tech.color} border border-galaxy-indigo/30 shadow-sm font-bold text-lg`}
                >
                  {tech.name}
                </div>
              </motion.div>
      ...
      <div className="py-16 bg-gradient-to-br from-deep-space to-cosmic-purple">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center"
          >
            <h2 className="text-base text-nebula-blue-200 font-semibold tracking-wide uppercase">
              Testimonials
            </h2>
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-stellar-white sm:text-4xl">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg font-medium text-stellar-white">
                      {testimonials[activeTestimonial].name}
                    </h4>
                    <p className="text-stellar-accent">
                      {testimonials[activeTestimonial].role}
                    </p>
                  </div>
                </div>
                <p className="mt-4 text-nebula-blue-200 italic">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-2 gap-6 sm:grid-cols-4">
            ...
            >
              ...
              <div className="mt-2 text-lg font-medium text-stellar-white">
                Projects Completed
              </div>
            </motion.div>
      ...
      <div className="relative bg-gradient-to-br from-deep-space to-cosmic-purple overflow-hidden">
        <div className="absolute inset-0">
          ...
          <motion.div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 10% 20%, rgba(167, 139, 250, 0.4) 0%, transparent 20%), radial-gradient(circle at 90% 80%, rgba(167, 139, 250, 0.3) 0%, transparent 20%)",
              backgroundSize: "50% 50%",
            }}
          />
        </div>
        ...
        >
          <h2 className="text-3xl font-extrabold tracking-tight text-stellar-white sm:text-4xl">
            ...
            <span className="block text-stellar-accent">
          ...
          >
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-deep-space bg-stellar-accent hover:bg-stellar-accent/90 md:py-4 md:text-lg md:px-8"
            >
              Contact Us
              <svg
