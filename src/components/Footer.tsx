        ...
        >
          <Link href="/" className="flex justify-center">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold bg-gradient-to-r from-purple-400 to-indigo-300 bg-clip-text text-transparent">
                NextGen CodeX
              </span>
            </div>
          </Link>
        ...
        >
          {navigation.main.map((item) => (
            ...
            >
              <Link 
                href={item.href} 
                className="text-base text-gray-400 hover:text-purple-400 transition-colors duration-200"
              >
                {item.name}
              </Link>
            </motion.div>
        ...
        >
          <form className="sm:flex">
            ...
            <input
              ...
              autoComplete="email"
              required
              className="w-full px-5 py-3 placeholder-gray-500 focus:ring-purple-500 focus:border-purple-500 sm:max-w-xs bg-gray-700 border-gray-600 rounded-md text-white"
              placeholder="Enter your email"
            />
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                type="submit"
                className="w-full flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-purple-600 to-indigo-500 hover:from-purple-700 hover:to-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors duration-200"
              >
                Subscribe
              </button>
            </div>
